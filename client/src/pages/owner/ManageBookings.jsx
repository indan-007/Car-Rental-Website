            ...
            {bookings.map((booking, index) => (
              ...
              <td className='p-3'>
                {booking.status === 'pending' ? (
                  ...
                  <span className={`px-3 py-1 rounded-full text-xs font-semibold ${booking.status === 'confirmed' ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-500'}`}>{booking.status}
                  </span>
                )}
              </td>
